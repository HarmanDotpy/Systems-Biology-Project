...
range_gamma_a= 1: 1: 300;
for j = 1:num_iter
    Parameter_Vec = [alpha_r; alpha_a; gamma_r; range_gamma_a(j); f; Ca; Cr_T; N; beta; Ro; A_T];
...
plot(range_gamma_a,avgperiod_laci,'LineWidth', 2,'DisplayName', 'TimePeriod lacI');
hold on
plot(range_gamma_a,avgperiod_arac,'LineWidth', 2,'DisplayName', 'TimePeriod AraC');
legend;
xlabel('Different values of gamma_a');
