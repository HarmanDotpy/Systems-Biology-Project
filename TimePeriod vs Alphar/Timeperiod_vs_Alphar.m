...
for j = 1:num_iter
    Parameter_Vec = [range_alphar(j); alpha_a; gamma_r; gamma_a; f; Ca; Cr_T; N; beta; Ro; A_T];
...
plot(range_alphar,avgperiod_laci,'LineWidth', 2,'DisplayName', 'TimePeriod_lacI');
hold on
plot(range_alphar,avgperiod_arac,'LineWidth', 2,'DisplayName', 'TimePeriod_AraC');
legend;
xlabel('Different values of Alpha_r');
